...
// import { SQSMessageType, SQSSendEmailArgs, SQSSendNotificationArgs } from './types';
...
//         } catch (err) {
//             Logger.Error(`Email enqueued Error: ${args.template}`, '[QUEUE]');
//         }
//     }

//     async EnqueueNotification(args: SQSSendNotificationArgs) {
//         try {
//             const command = new SendMessageCommand({
//                 QueueUrl: AppConfig.AWS.QUEUE_URL,
...
//         } catch (err) {
//             Logger.Error(`Notification enqueued Error: ${args.type}`, '[QUEUE]');
//         }
//     }
// }
